...
namespace CraftSynth.BuildingBlocks.WindowsNT.UserActivityHookNamespace
{
	public class MouseEventArgsFull : MouseEventArgs
	{
		public bool IsReleased { get; set; }
		public new int Clicks { get; set; }
		public bool WasLongPress { get; set; }

		public bool Handled { get; set; }

		public MouseEventArgsFull(MouseButtons button, bool isReleased, bool wasLongPress, int clicks, int x, int y, int delta)
			: base(button, clicks, x, y, delta)
		{
			this.IsReleased = isReleased;
			this.WasLongPress = WasLongPress;
		}
	...
	/// Source: http://www.codeproject.com/KB/cs/globalhook.aspx
	/// </summary>
	public class UserActivityHook
	{
		...
		public delegate void MouseEventHandlerFull(object sender, MouseEventArgsFull e);
		/// <summary>
		/// Occurs when the user moves the mouse, presses any mouse button or scrolls the wheel
		/// </summary>
		public event MouseEventHandlerFull OnMouseActivity;
		/// <summary>
		/// Occurs when the user presses a key
		/// </summary>
		public event KeyEventHandler KeyDown;

		public bool KeyDownIsNull()
		{
			return KeyDown == null;
		}
		/// <summary>
		...
		public void Start(bool InstallMouseHook, bool InstallKeyboardHook)
		{
			...
			if (hKeyboardHook == 0 && InstallKeyboardHook)
			{
				...
				hKeyboardHook = SetWindowsHookEx(
				   ...
				   mar //http://stackoverflow.com/questions/17897646/gma-useractivitymonitor-setwindowshookex-error-126
		...
		{
			bool handled = false;
			if (System.Threading.Monitor.TryEnter(_mouseEventLock, new TimeSpan(1)))
			//{
			//	handled = true;
			//}
			//else
			{
				try
				{
					...
					if ((nCode >= 0) && (OnMouseActivity != null))
					{
						...
						//generate event 
						MouseEventArgsFull e = new MouseEventArgsFull(
							button,
							isReleased,
							false,
							clickCount,
				...
				{
					System.Threading.Monitor.Exit(_mouseEventLock);
				}
			}
		...
		private object _keyboardEventLock = new object();
		/// <summary>
		...
		{//CraftSynth.BuildingBlocks.Common.Misc.BeepInNewThread(5000,30);
			//indicates if any of underlaing events set e.Handled flag
			bool handled = false;

			if (System.Threading.Monitor.TryEnter(_keyboardEventLock, new TimeSpan(1)))
			{
				try
				{
					...
					if ((nCode >= 0) && (KeyDown != null || KeyUp != null || KeyPress != null))
					{
						...
						if (KeyDown != null && (wParam == WM_KEYDOWN || wParam == WM_SYSKEYDOWN))
						{
							...
							//Trace.WriteLine(MyKeyboardHookStruct.vkCode.ToString());
				...
				{
					System.Threading.Monitor.Exit(_keyboardEventLock);
				}
			}
